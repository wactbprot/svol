...
dws = Asin(tsr/fr);
       ...
       Circle(20558) = {20034, 20010, 20031};
        ...
        Point(20124) = {r1*Sin(wts1 + dwfl), r1*Cos(wts1 + dwfl),  fhl};
        Point(20125) = {r1*Sin(wts1 - dwfl), r1*Cos(wts1 - dwfl),  fhl};
         Line(20661) = {20024, 20124};
         Line(20662) = {20025, 20125};
...
zts1 = fhl + 5;
       ...
       Circle(21558) = {21034, 21010, 21031};
        ...
        Point(21124) = {r1*Sin(wts2 + dwfl), r1*Cos(wts2 + dwfl),  fhl};
        Point(21125) = {r1*Sin(wts2 - dwfl), r1*Cos(wts2 - dwfl),  fhl};
         Line(21661) = {21024, 21124};
         Line(21662) = {21025, 21125};
...
zts1 = fhl + 5;
       ...
       Circle(22558) = {22034, 22010, 22031};
        ...
        Point(22124) = {r1*Sin(wts3 + dwfl), r1*Cos(wts3 + dwfl),  fhl};
        Point(22125) = {r1*Sin(wts3 - dwfl), r1*Cos(wts3 - dwfl),  fhl};
         Line(22661) = {22024, 22124};
         Line(22662) = {22025, 22125};
...
zts2 = fhr - 5;
       ...
       Circle(23558) = {23034, 23010, 23031};
        ...
        Point(23122) = {r1*Sin(wts1 + dwfl), r1*Cos(wts1 + dwfl),  fhr};
        Point(23123) = {r1*Sin(wts1 - dwfl), r1*Cos(wts1 - dwfl),  fhr};
         Line(23659) = {23022, 23122};
         Line(23660) = {23023, 23123};
...
zts2 = fhr - 5;
       ...
       Circle(24558) = {24034, 24010, 24031};
        ...
        Point(24122) = {r1*Sin(wts2 + dwfl), r1*Cos(wts2 + dwfl),  fhr};
        Point(24123) = {r1*Sin(wts2 - dwfl), r1*Cos(wts2 - dwfl),  fhr};
         Line(24659) = {24022, 24122};
         Line(24660) = {24023, 24123};
...
zts2 = fhr - 5;
       ...
       Circle(25558) = {25034, 25010, 25031};
        ...
        Point(25122) = {r1*Sin(wts3 + dwfl), r1*Cos(wts3 + dwfl),  fhr};
        Point(25123) = {r1*Sin(wts3 - dwfl), r1*Cos(wts3 - dwfl),  fhr};
         Line(25659) = {25022, 25122};
         Line(25660) = {25023, 25123};
...
zts3 = (fhr + fhl)/2;
       ...
       Circle(26558) = {26034, 26010, 26031};
        ...
        Point(26122) = {r1*Sin(wts4 + dwfl), r1*Cos(wts4 + dwfl),  fhr};
        Point(26123) = {r1*Sin(wts4 - dwfl), r1*Cos(wts4 - dwfl),  fhr};
        Point(26124) = {r1*Sin(wts4 + dwfl), r1*Cos(wts4 + dwfl),  fhl};
        Point(26125) = {r1*Sin(wts4 - dwfl), r1*Cos(wts4 - dwfl),  fhl};
         Line(26659) = {26022, 26122};
         Line(26660) = {26023, 26123};
         Line(26661) = {26024, 26124};
         Line(26662) = {26025, 26125};
...
// Abstand von Flanschfläche aussen
       ...
       Circle(27558) = {27034, 27010, 27031};
        ...
        Point(27122) = {r1*Sin(wts5 + dwfl), r1*Cos(wts5 + dwfl),  fhr};
        Point(27123) = {r1*Sin(wts5 - dwfl), r1*Cos(wts5 - dwfl),  fhr};
        Point(27124) = {r1*Sin(wts5 + dwfl), r1*Cos(wts5 + dwfl),  fhl};
        Point(27125) = {r1*Sin(wts5 - dwfl), r1*Cos(wts5 - dwfl),  fhl};
         Line(27659) = {27022, 27122};
         Line(27660) = {27023, 27123};
         Line(27661) = {27024, 27124};
         Line(27662) = {27025, 27125};
...
// Abstand von Flanschfläche aussen
       ...
       Circle(29558) = {29034, 29010, 29031};
        ...
        Point(29122) = {r1*Sin(wts6 + dwfl), r1*Cos(wts6 + dwfl),  fhr};
        Point(29123) = {r1*Sin(wts6 - dwfl), r1*Cos(wts6 - dwfl),  fhr};
        Point(29124) = {r1*Sin(wts6 + dwfl), r1*Cos(wts6 + dwfl),  fhl};
        Point(29125) = {r1*Sin(wts6 - dwfl), r1*Cos(wts6 - dwfl),  fhl};
         Line(29659) = {29022, 29122};
         Line(29660) = {29023, 29123};
         Line(29661) = {29024, 29124};
         Line(29662) = {29025, 29125};
...
Line(29663) = {24024, 21022};
Line(29664) = {24025, 21023};
Line(29665) = {20022, 23024};
Line(29666) = {20023, 23025};
Line(29667) = {22022, 25024};
Line(29668) = {22023, 25025};
